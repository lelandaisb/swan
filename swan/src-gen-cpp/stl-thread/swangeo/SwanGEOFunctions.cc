#include <iostream>
#include "SwanGEOFunctions.h"

float SwanGEOFunctions::nextWaveHeight()
{
	if(dataWave != NULL)
	{
...
float SwanGEOFunctions::nextDepth()
{
	if(dataDepth != NULL)
	{
...
float SwanGEOFunctions::nextBottomMotion()
{
		if(dataBottom != NULL)
		{
...
float SwanGEOFunctions::nextLon()
{
	if(dataLon != NULL)
	{
...
float SwanGEOFunctions::nextLat()
{
	if(dataLat != NULL)
		{
